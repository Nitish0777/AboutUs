...
const Container = ({ onContainerClick, show, src }) => {
  return (
    <Box
  ...
  return (
    <Box marginLeft="0.5%" marginRight="0.5%">
      ...
      <Container
        ...
        show={showContainer1}
        src={
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4GxtAzEUs7P5g8YZREbJgCN3RkVKvwNuIW7rnW85bOV-y25iIb_v09CH43Z5loIS7XYI&usqp=CAU"
        }
      />
      <Container
        ...
        show={showContainer2}
        src={
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDvQiXnvLr2M0hLK04YOWDFdTpH-8eHXiJV8flEqRUOYQQ90KQvmFjBw&s"
        }
      />
      <Container
        ...
        show={showContainer3}
        src={
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvjVGgXXCfNXKqilYe0gkvdAtvnCV_x-inrffSsWRQj4TZmGTW_2DqZHI39xYhp0yyW8s&usqp=CAU"
        }
      />
    </Box>
  );
